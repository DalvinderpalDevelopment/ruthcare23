...
if(!empty($group_1['content_layout_option'])): $group_1_option = $group_1['content_layout_option'] == 'reversed' ? 'flex-row-reverse' : ''; endif;
...
if(!empty($group_2['content_layout_option'])): $group_2_option = $group_2['content_layout_option'] == 'reversed' ? 'flex-row-reverse' : ''; endif;
