<?php 
if(is_single()) { global $post; $post_ID = !empty($post->ID) ? array($post->ID) : ''; }
    ...
    <div class="container pt-4 pb-3">
        ...
        <div class="row">
            <?php if($posts->have_posts()) : 
                ...
                $carousel = $post_count > 3 ? 'owl-carousel px-2 px-md-5' : 'justify-content-center';
                $layout = $post_count > 3 ? '' : 'col-md-6 col-lg-4';
                echo '<div class="card-group articles-carousel ' . $carousel . '">';
                        ...
                        <div class="card article h-100 shadow">
                            ...
                            <div class="card-body article-info p-3">
                                <div class="article-meta d-flex">
                                    ...
                                    <div class="article-term col-6 d-flex justify-content-end">
